...
public class DBDeckDao extends AbstractDao<DBDeck, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property DateCreated = new Property(5, long.class, "dateCreated", false, "DATE_CREATED");
        public final static Property LastUpdateDate = new Property(6, long.class, "lastUpdateDate", false, "LAST_UPDATE_DATE");
        ...
        public final static Property MinAppVersion = new Property(9, String.class, "minAppVersion", false, "MIN_APP_VERSION");
        public final static Property Tags = new Property(10, String.class, "tags", false, "TAGS");
        public final static Property Published = new Property(11, boolean.class, "published", false, "PUBLISHED");
        public final static Property OriginalId = new Property(12, int.class, "originalId", false, "ORIGINAL_ID");
    };
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'DBDECK' (" + //
                ...
                "'DATE_CREATED' INTEGER NOT NULL ," + // 5: dateCreated
                "'LAST_UPDATE_DATE' INTEGER NOT NULL ," + // 6: lastUpdateDate
                "'VERSION' TEXT NOT NULL ," + // 7: version
                "'EDITABLE' INTEGER NOT NULL ," + // 8: editable
                "'MIN_APP_VERSION' TEXT NOT NULL ," + // 9: minAppVersion
                "'TAGS' TEXT," + // 10: tags
                "'PUBLISHED' INTEGER NOT NULL ," + // 11: published
                "'ORIGINAL_ID' INTEGER NOT NULL );"); // 12: originalId
    }
    ...
    protected void bindValues(SQLiteStatement stmt, DBDeck entity) {
        ...
        stmt.bindLong(6, entity.getDateCreated());
        stmt.bindLong(7, entity.getLastUpdateDate());
        stmt.bindString(8, entity.getVersion());
        stmt.bindLong(9, entity.getEditable() ? 1l: 0l);
        stmt.bindString(10, entity.getMinAppVersion());
 
        String tags = entity.getTags();
        if (tags != null) {
            stmt.bindString(11, tags);
        }
        stmt.bindLong(12, entity.getPublished() ? 1l: 0l);
        stmt.bindLong(13, entity.getOriginalId());
    }
    ...
    public DBDeck readEntity(Cursor cursor, int offset) {
        DBDeck entity = new DBDeck( //
            ...
            cursor.getLong(offset + 5), // dateCreated
            cursor.getLong(offset + 6), // lastUpdateDate
            cursor.getString(offset + 7), // version
            cursor.getShort(offset + 8) != 0, // editable
            cursor.getString(offset + 9), // minAppVersion
            cursor.isNull(offset + 10) ? null : cursor.getString(offset + 10), // tags
            cursor.getShort(offset + 11) != 0, // published
            cursor.getInt(offset + 12) // originalId
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, DBDeck entity, int offset) {
        ...
        entity.setDateCreated(cursor.getLong(offset + 5));
        entity.setLastUpdateDate(cursor.getLong(offset + 6));
        entity.setVersion(cursor.getString(offset + 7));
        entity.setEditable(cursor.getShort(offset + 8) != 0);
        entity.setMinAppVersion(cursor.getString(offset + 9));
        entity.setTags(cursor.isNull(offset + 10) ? null : cursor.getString(offset + 10));
        entity.setPublished(cursor.getShort(offset + 11) != 0);
        entity.setOriginalId(cursor.getInt(offset + 12));
     }
